...
const EditProfile = ({ user }) => {
  ...
  const [showToast, setShowToast] = useState(false); // update profile toast message
  ...
  const saveProfile = async () => {
    ...
    try {
      ...
      setShowToast(true); // update local state - showToast
      setTimeout(() => {
        // hide toast msg UI after 3 secs
        setShowToast(false);
      }, 3000);
    } catch (err) {
  ...
  return (
    <>
      ...
      {/*  daisyUI 'toast 'component - Profile Updated Success Msg UI */}
      {showToast === true ? (
